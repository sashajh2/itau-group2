...
class UnifiedHyperparameterOptimizer:
    ...
    def __init__(self, model_type, model_name=None, device=None, log_dir="optimization_results"):
        ...
        self.pbt_optimizer = PopulationBasedTrainer(model_type, model_name, device, f"{log_dir}/pbt")
    ...
    def optimize(self, method, training_filepath, test_reference_filepath, test_filepath,
        ...
        if method == "bayesian":
            ...
            allowed = ["population_size", "generations", "epochs_per_generation", "evolution_frequency"]
            filtered = {k: kwargs[k] for k in allowed if k in kwargs}
