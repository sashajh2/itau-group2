...
def main(data_dir):
    ...
    print("=" * 72)
    print("  (generated variants that coincide as strings with a legitimate")
    print("   domain in another split -- string collision among very short")
    print("   domains, not reuse of an identity across splits)")
    for name, df in splits.items():
